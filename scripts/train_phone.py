...
_DATASET_DEFAULT = "/content/datasets/phone"
_DATA_CFG_DEFAULT = os.path.join(ROOT, "configs", "phone.yaml")
_OUTPUT_DEFAULT   = os.path.join(ROOT, "models")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Sentinel AI — Phone/Device Detection Training",
        add_help=True,
        allow_abbrev=False,
    )
    parser.add_argument(
        ...
        help="Path to YOLO dataset YAML (default: configs/phone.yaml inside repo root)",
    )
    parser.add_argument(
        "--label-dir",
...
def main(args: argparse.Namespace) -> None:
    ...
    print("=" * 60)
    print("  Sentinel AI — Phone/Device Detection Training")
    print("=" * 60)
    ...
    best_pt = os.path.join(run_dir, "phone", "weights", "best.pt")
    last_pt = os.path.join(run_dir, "phone", "weights", "last.pt")
