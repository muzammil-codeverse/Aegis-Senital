...
export default function CrossSourceCorrelationPanel({ correlations = [], onReview, onCorrelate, loading }) {
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
        <h3 style={{ margin: 0 }}>Cross-Source Correlations ({correlations.length})</h3>
        <button onClick={onCorrelate} disabled={loading}
      ...
      {!correlations.length && <div style={{ color: '#6b7280', fontSize: 13 }}>No correlations yet.</div>}
