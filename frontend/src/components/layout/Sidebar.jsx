...
const NAV_ITEMS = [
  ...
  { id: 'investigation', label: 'Investigation', permission: 'investigation:read' },
  { id: 'drone-simulation', label: 'Drone Sim', permission: 'drone:read' },
  { id: 'drone-mission-planner', label: 'Mission Planner', permission: 'drone:read' },
  ...
  { id: 'model-governance', label: 'Model governance', permission: 'model:read' },
