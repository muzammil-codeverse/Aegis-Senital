...
class AuditAction(Enum):
    ...
    MODEL_GOVERNANCE_VALIDATE = "model_governance_validate"
    MODEL_GOVERNANCE_ROLLBACK = "model_governance_rollback"
    MODEL_GOVERNANCE_PROMOTION_DENIED = "model_governance_promotion_denied"
