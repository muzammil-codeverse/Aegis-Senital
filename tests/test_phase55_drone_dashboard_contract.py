...
def test_phase55_drone_dashboard_files_exist():
    required = [
...
def test_phase55_drone_dashboard_api_contract_strings():
    ...
    assert "/api/drone-simulation/runtime" in api_text
    assert "/api/drone-simulation/events" in api_text
    assert "/api/drone-simulation/stream/start" in api_text
    assert "/api/drone-simulation/stream/stop" in api_text
    assert "/api/drone-simulation/runtime" in fe_api_text
